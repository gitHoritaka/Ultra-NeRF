    ...
    *,
    ...
    metadata = {
        ...
        "probe_geometry": {
            ...
            "probe_type": getattr(probe_geometry, "probe_type", "linear"),
            "convex_center_x": getattr(probe_geometry, "convex_center_x", None),
            "convex_center_y": getattr(probe_geometry, "convex_center_y", None),
            "convex_angle_deg": getattr(probe_geometry, "convex_angle_deg", None),
            "convex_outer_radius_px": getattr(probe_geometry, "convex_outer_radius_px", None),
            "convex_inner_radius_px": getattr(probe_geometry, "convex_inner_radius_px", None),
            "convex_scale_x_mm": getattr(probe_geometry, "convex_scale_x_mm", None),
            "convex_scale_y_mm": getattr(probe_geometry, "convex_scale_y_mm", None),
            "convex_n_rays": getattr(probe_geometry, "convex_n_rays", None),
            "convex_n_samples": getattr(probe_geometry, "convex_n_samples", None),
        },
